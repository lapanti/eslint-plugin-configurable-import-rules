...
export async function run(argv, cb) {
    ...
    await program
        ...
        .option('--check [boolean]', `(optional) Whether to check for and fail if there is a diff. No output will be written. Typically used during CI. (default: ${OPTION_DEFAULTS[OPTION_TYPE.CHECK]})`, parseBoolean)
        .option('--config-emoji <config-emoji>', '(optional) Custom emoji to use for a config. Format is `config-name,emoji`. Default emojis are provided for common configs. To remove a default emoji and rely on a badge instead, provide the config name without an emoji. Option can be repeated.', collectCSVNested, [])
        ...
        .option('--ignore-deprecated-rules [boolean]', `(optional) Whether to ignore deprecated rules from being checked, displayed, or updated. (default: ${OPTION_DEFAULTS[OPTION_TYPE.IGNORE_DEPRECATED_RULES]})`, parseBoolean)
        .option('--init-rule-docs [boolean]', `(optional) Whether to create rule doc files if they don't yet exist. (default: ${OPTION_DEFAULTS[OPTION_TYPE.INIT_RULE_DOCS]})`, parseBoolean)
        ...
        .option('--rule-doc-notices <notices>', `(optional) Ordered, comma-separated list of notices to display in rule doc. Non-applicable notices will be hidden. (choices: "${Object.values(NOTICE_TYPE).join('", "')}") (default: ${OPTION_DEFAULTS[OPTION_TYPE.RULE_DOC_NOTICES]})`, collectCSV, [])
        ...
        .option('--rule-doc-section-options [boolean]', `(optional) Whether to require an "Options" or "Config" rule doc section and mention of any named options for rules with options. (default: ${OPTION_DEFAULTS[OPTION_TYPE.RULE_DOC_SECTION_OPTIONS]})`, parseBoolean)
        ...
        .option('--rule-list-columns <columns>', `(optional) Ordered, comma-separated list of columns to display in rule list. Empty columns will be hidden. (choices: "${Object.values(COLUMN_TYPE).join('", "')})" (default: ${OPTION_DEFAULTS[OPTION_TYPE.RULE_LIST_COLUMNS]})`, collectCSV, [])
