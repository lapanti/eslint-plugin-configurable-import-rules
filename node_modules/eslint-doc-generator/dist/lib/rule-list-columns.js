...
export function getColumns(plugin, details, configsToRules, ruleListColumns, pluginPrefix, ignoreConfig) {
    const columns = {
        ...
        [COLUMN_TYPE.FIXABLE_AND_HAS_SUGGESTIONS]: details.some((detail) => detail.fixable || detail.hasSuggestions),
        ...
        [COLUMN_TYPE.TYPE]: details.some((detail) => detail.type && RULE_TYPES.includes(detail.type) // eslint-disable-line @typescript-eslint/no-explicit-any
        ),
    };
