 ...
 */
function getRuleNoticeLines(ruleName, plugin, configsToRules, pluginPrefix, pathPlugin, pathRuleDoc, configEmojis, ignoreConfig, ruleDocNotices, urlConfigs, urlRuleDoc) {
    const lines = [];
 ...
 */
export function generateRuleHeaderLines(description, name, plugin, configsToRules, pluginPrefix, pathPlugin, pathRuleDoc, configEmojis, ignoreConfig, ruleDocNotices, ruleDocTitleFormat, urlConfigs, urlRuleDoc) {
    return [
        makeRuleDocTitle(name, description, pluginPrefix, ruleDocTitleFormat),
        ...getRuleNoticeLines(name, plugin, configsToRules, pluginPrefix, pathPlugin, pathRuleDoc, configEmojis, ignoreConfig, ruleDocNotices, urlConfigs, urlRuleDoc),
        '',
