...
function loadPackageJson(path) {
    ...
    const pluginPackageJson = JSON.parse(readFileSync(join(pluginRoot, 'package.json'), 'utf8'));
...
export function getPluginPrefix(path) {
    const pluginPackageJson = loadPackageJson(path);
 ...
 */
export function getPathWithExactFileNameCasing(path) {
