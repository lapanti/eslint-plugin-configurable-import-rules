...
function buildRuleRow(columnsEnabled, rule, configsToRules, pluginPrefix, pathPlugin, pathRuleDoc, pathRuleList, configEmojis, ignoreConfig, urlRuleDoc) {
    const columns = {
        ...
        [COLUMN_TYPE.REQUIRES_TYPE_CHECKING]: rule.requiresTypeChecking
            ...
            : '',
        [COLUMN_TYPE.TYPE]: rule.type ? EMOJIS_TYPE[rule.type] : '', // Convert union type to enum.
    };
...
function generateRulesListMarkdown(columns, details, configsToRules, pluginPrefix, pathPlugin, pathRuleDoc, pathRuleList, configEmojis, ignoreConfig, urlRuleDoc) {
 ...
 */
function generateRulesListMarkdownWithRuleListSplit(columns, details, plugin, configsToRules, pluginPrefix, pathPlugin, pathRuleDoc, pathRuleList, configEmojis, ignoreConfig, ruleListSplit, headerLevel, urlRuleDoc) {
...
export function updateRulesList(details, markdown, plugin, configsToRules, pluginPrefix, pathRuleDoc, pathRuleList, pathPlugin, configEmojis, ignoreConfig, ruleListColumns, ruleListSplit, urlConfigs, urlRuleDoc) {
    ...
    const list = ruleListSplit
        ? generateRulesListMarkdownWithRuleListSplit(columns, details, plugin, configsToRules, pluginPrefix, pathPlugin, pathRuleDoc, pathRuleList, configEmojis, ignoreConfig, ruleListSplit, ruleListSplitHeaderLevel, urlRuleDoc)
        : generateRulesListMarkdown(columns, details, configsToRules, pluginPrefix, pathPlugin, pathRuleDoc, pathRuleList, configEmojis, ignoreConfig, urlRuleDoc);
